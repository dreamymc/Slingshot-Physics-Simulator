# slingshot_fixed_ui_final_patched.py
# pip install pygame
# Run: python slingshot_fixed_ui_final_patched.py
...
pygame.display.set_caption("Slingshot — final (patched)")
...
while running:
    ...
    draw_text(1000, 30, f"Gravity: {GRAVITY:.2f} m/s²   Cd: {('on' if ENABLE_AIR_DRAG else 'off')}", small)
